...
namespace EleccionsMunicipals.Migrations
{
    ...
    [Migration("20230618115101_OtropcInitial")]
    partial class OtropcInitial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EleccionsMunicipals.Models.Candidat", b =>
                {
                    ...
                    b.Property<long?>("LlistaPartitMunicipiID")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("LlistaPartitMunicipiID");

                    b.ToTable("Candidat");
                });

            modelBuilder.Entity("EleccionsMunicipals.Models.LlistaPartitMunicipi", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EleccionsMunicipals.Models.Candidat", b =>
                {
                    b.HasOne("EleccionsMunicipals.Models.LlistaPartitMunicipi", null)
                        .WithMany("candidats")
                        .HasForeignKey("LlistaPartitMunicipiID");
                });
